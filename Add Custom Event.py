...
font = pygame.font.SysFont("Monotype Corisva", FONT_SIZE)
...
# Create sprites
sprite1 = Sprite(pygame.Color('light pink'), 20, 30)
...
sprite2 = Sprite(pygame.Color('light blue'), 20, 30)
...
while running:
  ...
  if not won:
    ...
    x_1 = (keys[pygame.K_S] - keys[pygame.K_A]) * MOVEMENT_SPEED
    y_1 = (keys[pygame.K_D] - keys[pygame.K_W]) * MOVEMENT_SPEED
    sprite2.move(x_1, y_1)
